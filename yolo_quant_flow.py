...
def get_parser():
    ...
    parser.add_argument('--num-finetune-epochs', default=1, type=int,
...
def main(cmdline_args):
    ...
    model, trainloader, testloader, calibloader, dataset = prepare_model(opt.calibrator,
                                                            hyp, opt, device)
    print("_____________PREPARE_MODEL")
    ...
    print("_____________EVALUATE_ACCURACY")
    # Calibrate the model
    with torch.no_grad():
        calibrate_model(
            model=model,
